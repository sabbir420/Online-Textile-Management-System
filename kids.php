  ...
  <div class="row">
    ...
    <div class="collapse navbar-collapse col-xm-12" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="kids.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kids<span class="sr-only">(current)</span></a></li>		<li><a href="AboutUs.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;About Us</a></li>
...
<div id ="content2">
	...
	{
		$get_pro="select*from products where product_cat =3 order by RAND() LIMIT 0,7";
