  ...
  <div class="row">
    ...
    <div class="collapse navbar-collapse col-xm-12" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="inddex.php">Home<span class="sr-only">(current)</span></a></li>
        <li class="dropdown">
...
<div id ="content2">
					...
					<div class='col-md-3 col-md2 animated wow fadeInLeft' data-wow-delay='.5s'   >
						<div class='col-md1 simpleCart_shelfItem'>
							...
							<div class='price'>
									...
									<button class='btn btn-danger'><a href='inddex.php?add_cart=$pro_id' class='item_add' style='color:black'>Add  Cart</a></button>
	...
	{
		$get_pro="select*from products where product_brand =5 order by RAND() LIMIT 0,7";
